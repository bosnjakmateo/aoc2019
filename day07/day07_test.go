...
func TestRunAmplifiersWithFeedbackLoop(t *testing.T) {
	runAmplifiersWithFeedbackLoop(
		[]int{3, 26, 1001, 26, -4, 26, 3, 27, 1002, 27, 2, 27, 1, 27, 26, 27, 4, 27, 1001, 28, -1, 28, 1005, 28, 6, 99, 0, 0, 5},
		[]int{9, 8, 7, 6, 5},
	)

	runAmplifiersWithFeedbackLoop(
		[]int{3, 52, 1001, 52, -5, 52, 3, 53, 1, 52, 56, 54, 1007, 54, 5, 55, 1005, 55, 26, 1001, 54, -5, 54, 1105, 1,
